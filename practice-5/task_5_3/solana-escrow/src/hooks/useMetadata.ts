...
const DUMMY_TOKENS: Record<string, TokenMetadata> = {
  ...
  //
  GxfaEXin86jdJBeoiiFUwaUVrpdx4yZB1apzcgutJ162: {
    address: "GxfaEXin86jdJBeoiiFUwaUVrpdx4yZB1apzcgutJ162",
    symbol: "SBTC-3",
    name: "Solana UA Bootcamp #3",
    decimals: 2,
    icon: "https://devnet.bundlr.network/GmYZRbXWgxNswi54JWBrhKJXwe2WqattTJ5VzrAruuXW",
  },
  "8bdgJLUHdLBKVqUfZtzfv8Cd5Rn9zhjrjg5XLahskviD": {
    address: "8bdgJLUHdLBKVqUfZtzfv8Cd5Rn9zhjrjg5XLahskviD",
    symbol: "TSBC-3.2",
    name: "Token Solana UA Bootcamp #3 v.2",
    decimals: 2,
    icon: "https://devnet.bundlr.network/GmYZRbXWgxNswi54JWBrhKJXwe2WqattTJ5VzrAruuXW",
  },  
  "8iQpSMuocCGBQn7vA6sXFWDkJnG12mHkUAPjKFA5umcr": {
    address: "8iQpSMuocCGBQn7vA6sXFWDkJnG12mHkUAPjKFA5umcr",
    symbol: "TSBC",
    name: "Token Solana Bootcamp #3 (Rust)",
    decimals: 2,
    icon: "https://devnet.bundlr.network/GmYZRbXWgxNswi54JWBrhKJXwe2WqattTJ5VzrAruuXW",
  },    
};
